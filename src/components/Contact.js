              ...
              <ul className="custom-list">
                <li>
                  <h6 className="font-weight-600">
                    ...
                    <span className="contact-content">+44 7907 433165</span>
                  </h6>
                </li>
                <li>
                  <h6 className="font-weight-600">
                    ...
                    <span className="contact-content">advyt@outlook.com</span>
                  </h6>
                </li>
                <li>
                  <h6 className="font-weight-600">
                    ...
                    <span className="contact-content">advytv</span>
                  </h6>
                </li>
                <li>
                  <h6 className="font-weight-600">
                    ...
                    <span className="contact-content">Advyt Varma</span>
                  </h6>
                </li>
              </ul>
